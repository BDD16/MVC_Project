...
public class Communication implements PipeMsgListener {
	...
	private HashMap<String, Service> services = new HashMap<String, Service>();
        ArrayBlockingQueue<Message> goingUP;
    ...
    public Communication(Network network, ArrayBlockingQueue<Message> TransferPipe) throws Exception {
        goingUP = TransferPipe;
        if(!network.isStarted()) { //Can't correctly instantiate the Communication class if network isn't running.
			throw new Exception("network isn't started");
		}
	...
	/**
	 * Create an input pipe. All message received will be catch in the pipeMsgEvent method.
	 */
